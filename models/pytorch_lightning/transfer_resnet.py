...
class TransferLearningModel(pl.LightningModule):
    ...
    def prepare_data(self, valid_fraction=0.05, test_fraction=0.2):
        dataset = DatasetFromHDF5(self.data_path, 'iq', 'labels', 'sirs')
    ...
    def add_model_specific_args(parent_parser):
        ...
        # model = torch.load("/media/backup/Arsenal/thesis_results/res_intf_free_usrp_all/epoch=4.ckpt",
        #                    map_location='cuda:0')
...
def get_args() -> argparse.Namespace:
    root_path = "/media/backup/Arsenal/rf_dataset_inets/dataset_intf_bpsk_snr10_1024.h5"
