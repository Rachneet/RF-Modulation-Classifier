...
import sys
import h5py
from data_processing.hdf5_manipulator.parser import get_args_merge as parser
from data_processing.hdf5_manipulator import msg
from data_processing.hdf5_manipulator import check
from data_processing.hdf5_manipulator.merge import get_filelist
from data_processing.hdf5_manipulator.combine_big import load
...
if __name__ == '__main__':
    ...
    # output.close()
    # msg.info("Done")
    x = get_size(['/home/rachneet/rf_dataset_inets/vsg_cfo1_sampled.h5'])
    print(x)